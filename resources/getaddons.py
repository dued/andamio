...
Dada una lista de rutas, busca y devuelve una lista de rutas de complementos válidas.
Con el flag -m, se devolverá una lista de nombres de módulos.
"""
...
def is_module(path):
    """Devuelve False si la ruta no contiene un módulo de Odoo y, en caso contrario,
    la ruta completa al manifiesto del módulo."""
